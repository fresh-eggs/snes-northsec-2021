...
.define flag_offset_0       $1200
.define flag_offset_1       $1204
.define flag_offset_2       $1208
.define flag_offset_3       $120C
.define should_take_input   $1210
.define joy_1_pressed_h     $1214
.define joy_1_pressed_l     $1218
.define joy_1_raw_input_h   $121C
.define joy_1_raw_input_l   $1220
...
print_good_input_0:
	ldx.w   #$09A0         ; assign vram location $1000 to $2116/7
	stx     $2116
	ldx     #$0000
...
print_good_input_1:
	ldx.w   #$09C0         ; assign vram location $1000 to $2116/7
	stx     $2116
	ldx     #$0000
...
print_good_input_2:
	ldx.w   #$09E0         ; assign vram location $1000 to $2116/7
	stx     $2116
	ldx     #$0000
...
print_good_input_3:
	ldx.w   #$0A00          ; assign vram location $1000 to $2116/7
	stx     $2116
	ldx     #$0000
...
input_check_0:
	; -- check that flag_offset_0 has not yet been set, return otherwise
	lda     flag_offset_0
	and     #$FF
	...
	; -- check for input on the wrong byte 
	+ lda     joy_1_pressed_l
...
input_check_1:
	; -- check that flag_offset_1 has not yet been set, return otherwise
	lda     flag_offset_1
	and     #$FF
	beq     +               ;when z=1, continue (no previous input)
	jmp     input_check_2
...
input_check_2:
   ...
   ;  -- check against the actual value of the joypad we want
	+ lda    joy_1_pressed_h
	tax
	eor     #$28            ; Button_Select + Button_Up
	beq     +               ; "start" pressed? go to reset
...
text_0:
	.db		"FLAG-43TFD38D9PLVP9WX7N49DXAG6QX"
	.db		"7TQQQKBGMC9QRB6TTHUT7LA3P4CPJPUQ"
	.db		"PBR9YUN9X687LF9Y9CD6C3QP7F9X33G5"
...
main_screen:
	.db		"#==============================#"
	.db		"| [WELCOME TO THE SYSTEM V1.0] |"
	.db		"|                              |"
	.db		"|     PLEASE INPUT THE         |"
	.db		"|     SEQUENCE YOU WANT        |"
	.db		"|     PROCESSED, FOLLOWED      |"
	.db     "|     BY PRESSING START        |"
	.db		"#==============================#"
	.db		"                                "
	.db		"                                "
